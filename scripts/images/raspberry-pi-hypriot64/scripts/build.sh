...
mkfs.vfat -n BurmillaOS ${PART1_DEVICE}
...
echo "BurmillaOS: boot partition" > build/root/boot/boot.txt
echo "BurmillaOS: root partition" > build/root/root.txt
...
# populate kernel, bootloader and BurmillaOS rootfs
